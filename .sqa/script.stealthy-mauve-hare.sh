...
cp IM/ScipionCloud-EOSCSynergy-CESNET.radl github.com/I2PC/scipion-cloud/IM/ScipionCloud-EOSCSynergy-CESNET.radl
echo "Printing IM config file: github.com/I2PC/scipion-cloud/IM/ScipionCloud-EOSCSynergy-CESNET.radl"
cat github.com/I2PC/scipion-cloud/IM/ScipionCloud-EOSCSynergy-CESNET.radl
im_client.py -r "https://appsgrycap.i3m.upv.es:31443/im/" -a "/im/auth.dat" create_wait_outputs github.com/I2PC/scipion-cloud/IM/ScipionCloud-EOSCSynergy-CESNET.radl > ./im_radl.json
RETURN_CODE=$?
